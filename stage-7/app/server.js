...
app.get('/health', async (req, res) => {
  ...
  res.status(isHealthy ? 200 : 503).json({
    ...
    stage: 'Stage 7: DevSecOps (SAST + SCA + Secrets + IaC + DAST + CloudFront + WAF)',
...
app.listen(PORT, async () => {
  console.log(`=======================================================`);
  console.log(`🚀 ShopSphere Stage 7 Server running on port ${PORT}`);
  console.log(`🌐 Serving Host: ${os.hostname()}`);
  console.log(`🛡️ DevSecOps Controls: Active (SAST, SCA, Secrets, IaC, DAST)`);
