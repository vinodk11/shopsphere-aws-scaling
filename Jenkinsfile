pipeline {
    ...
    parameters {
        choice(
            ...
            description: 'Select ShopSphere stage (stage-1 = Monolith, stage-2 = EC2 + RDS)'
        )
        choice(
            name: 'ACTION',
            ...
            steps {
                dir("${env.TF_DIR}") {
                    ...
                    sh '''
                        ...
                        echo "Waiting for EC2 User-Data bootstrap (Node.js + Database)..."
